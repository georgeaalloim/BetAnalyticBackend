...
def main() -> int:
    ...
    if args.skip_sync:
        ...
        sync_summary["fixtures"] = {
            ...
            "safety_rule": (
                "Η ακριβής ώρα εμφανίζεται όταν υπάρχει ρητή και εύλογη ώρα από "
                "Fixtur.es ή Football-Data. Όταν υπάρχουν δύο timed πηγές πρέπει "
                "να συμφωνούν εντός 30 λεπτών· σε διαφωνία η ώρα κρύβεται. "
                "Προφανείς placeholder ώρες όπως 03:00 δεν εμφανίζονται."
            ),
        }
