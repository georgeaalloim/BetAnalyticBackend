...
def extract_metrics(
    ...
    """
    Κρατά μόνο τις βασικές μετρικές
...
def calculate_weighted_average(
    ...
    """
    Υπολογίζει σταθμισμένο μέσο όρο μιας μετρικής
    με βάρος τον αριθμό αξιολογημένων αγώνων.
    """
...
def run_tuning() -> dict[str, Any]:
    """
    Δοκιμάζει όλες τις τιμές prior_matches.

    Οι σεζόν 2022 και 2023 χρησιμοποιούνται
    για την επιλογή της καλύτερης τιμής.

    Η σεζόν 2024 εμφανίζεται ξεχωριστά
    ως validation.
    """
    ...
    for prior_matches in PRIOR_VALUES:
        print(
            f"Δοκιμή prior_matches={prior_matches}...",
            flush=True,
        )
    ...
    return {
        ...
        "recommended_prior_matches": (
            best_candidate["prior_matches"]
        ),
...
def main() -> None:
    ...
    output_path = "prior_tuning_results.json"
    ...
    print(
        "Προτεινόμενο prior_matches:",
        results["recommended_prior_matches"],
    )
    print(
